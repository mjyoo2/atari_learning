...
def get_dataset():
    dataset = []
    for i in range(99):
        with open('/sample/{}_state.pkl'.format(i), 'wb') as f:
            data = pkl.load(f)
            dataset.extend(data)
    with open('/sample/{}_state.pkl'.format(i), 'wb') as f:
        trainset = pkl.load(f)
...
x = Conv2D(filters=16, kernel_size=1, activation='relu', strides=1, padding='valid')(x)
x = Conv2D(filters=64, kernel_size=4, activation='relu', strides=2, padding='valid')(x)
x = Conv2D(filters=16, kernel_size=1, activation='relu', strides=1, padding='valid')(x)
x = Conv2D(filters=64, kernel_size=3, activation='relu', strides=1, padding='valid')(x)
x = Conv2D(filters=16, kernel_size=1, activation='relu', strides=1, padding='valid')(x)
x = Conv2D(filters=64, kernel_size=3, activation='relu', strides=1, padding='valid')(x)
x = Conv2D(filters=16, kernel_size=1, activation='relu', strides=1, padding='valid')(x)
...
x = Conv2DTranspose(filters=16, kernel_size=1, activation='relu', strides=1, padding='same')(x)
...
x = Conv2DTranspose(filters=16, kernel_size=1, activation='relu', strides=1, padding='same')(x)
outputs = Conv2DTranspose(filters=1, kernel_size=8, activation='sigmoid', padding='same', name='decoder_output')(x)
